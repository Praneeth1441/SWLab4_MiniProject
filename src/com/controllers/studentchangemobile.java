 ...
 */
@WebServlet("/studentchangemobile")
public class studentchangemobile extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public studentchangemobile() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String newmobile = request.getParameter("id");		
				...
				String query = "UPDATE student SET mobile_no = '"+ newmobile +"' WHERE id ="+Integer.toString(id);
