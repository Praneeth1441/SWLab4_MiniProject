...
<div id = "content" class = "contenta">
		...
		<h2 style="text-align: center">Register a Student</h2>
		<div class="container" style="width: 500px;text-align: center">
			<form method = "GET" action="studentregistration" onsubmit="return validation()" class="bg-light">
				
				<div class="form-group">
					<label for="user" class="font-weight-bold"> Name: </label>
					<input type="text" name="user" class="form-control" id="user" placeholder="Enter Student's name">
				...
				<div class="form-group">
					...
					<input type="text" name="mobile" class="form-control" id="mobileNumber" placeholder="Enter Student's mobile-no">
					<span id="mobileno" class="text-danger font-weight-bold"> </span>
				</div>

				<div class="form-group">
					<label class="font-weight-bold"> Email: </label>
					<input type="text" name="email" class="form-control" id="emails" placeholder="Enter Student's email-id">
					<span id="emailids" class="text-danger font-weight-bold"> </span>
				</div>
				
				<div class="form-group"> 
					<label class="font-weight-bold"> Class: </label>
					<input type="number" name="class" class="form-control" id="class" placeholder="Enter Student's class">
