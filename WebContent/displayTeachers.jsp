...
<div id = "content" class = "contenta">
        ...
        <%
			...
			<a href="adminaddteacher.jsp"><button>Add Teacher</button> </a>
			<form method = "GET" action = "deleteteacher">To delete a teacher enter his id below.<br><br>
			<input type = "number" name = "id"><br><br>
			<button type = "submit">Delete a Teacher</button></form></div>
</body>
</html>